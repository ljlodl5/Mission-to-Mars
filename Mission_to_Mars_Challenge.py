...
###  utilized assistance from following sites 
#https://stackoverflow.com/questions/46490626/getting-all-links-from-a-page-beautiful-soup (href links=c)
#https://github.com/emmanuelmartinezs/Mission-to-Mars for the following (browser find by css and browser find link by text concepts= a-c)
